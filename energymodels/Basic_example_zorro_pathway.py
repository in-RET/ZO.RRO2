# -*- coding: utf-8 -*-
"""
Created on Fri Jun 19 15:31:27 2026
...
def Basisszenario_pathway(PERMUATION: str) -> solph.EnergySystem:
    ...
    if feed_in_profile_new:
        ...
        energysystem.add(solph.components.Source(
            ...
            outputs={b_el_in: solph.Flow(fix=sequences['feed_in_profile_2009']['Wind_north_scaled'],
                                            ...
                                            investment=solph.Investment(
                                                                        ...
                                                                        # existing= (scalars['leistung_trapfade_bestand'][str(exist_year)]['onshore_wind_power_plant_north']
                                                                        #            if is_existing_year else 0),
                                                                        minimum = (None if not is_opt_year 
                                                                                   else (scalars['leistung_trapfade_bestand'][str(YEAR-5)]['onshore_wind_power_plant_north']-
                                                                                   scalars['leistung_trapfade_bestand'][str(exist_year)]['onshore_wind_power_plant_north'])),
        ...
        energysystem.add(solph.components.Source(
            ...
            outputs={b_el_in: solph.Flow(fix=sequences['feed_in_profile_2009']['Wind_east_scaled'],#
                                            ...
                                            investment=solph.Investment(
                                                                        ep_costs=epc_costs['onshore_wind_power_plant']['epc'] , 
                                                                        # existing= (scalars['leistung_trapfade_bestand'][str(exist_year)]['onshore_wind_power_plant_east']
                                                                        #            if is_existing_year else 0),
                                                                        minimum = (None if not is_opt_year 
                                                                                   else (scalars['leistung_trapfade_bestand'][str(YEAR-5)]['onshore_wind_power_plant_east']-
                                                                                         scalars['leistung_trapfade_bestand'][str(exist_year)]['onshore_wind_power_plant_east'])),
        ...
        energysystem.add(solph.components.Source(
            ...
            outputs={b_el_in: solph.Flow(fix=sequences['feed_in_profile_2009']['Wind_middle_scaled'],#
                                            ...
                                            investment=solph.Investment(
                                                                        ep_costs=epc_costs['onshore_wind_power_plant']['epc'] , 
                                                                        # existing= (scalars['leistung_trapfade_bestand'][str(exist_year)]['onshore_wind_power_plant_middle']
                                                                        #            if is_existing_year else 0),
                                                                        minimum = (None if not is_opt_year 
                                                                                   else (scalars['leistung_trapfade_bestand'][str(YEAR-5)]['onshore_wind_power_plant_middle']-
                                                                                         scalars['leistung_trapfade_bestand'][str(exist_year)]['onshore_wind_power_plant_middle'])),
        ...
        energysystem.add(solph.components.Source(
            ...
            outputs={b_el_in: solph.Flow(fix=sequences['feed_in_profile_2009']['Wind_swest_scaled'],#
                                            ...
                                            investment=solph.Investment(
                                                                        ep_costs=epc_costs['onshore_wind_power_plant']['epc'], 
                                                                        # existing= (scalars['leistung_trapfade_bestand'][str(exist_year)]['onshore_wind_power_plant_swest']
                                                                        #            if is_existing_year else 0),
                                                                        minimum = (None if not is_opt_year 
                                                                                   else (scalars['leistung_trapfade_bestand'][str(YEAR-5)]['onshore_wind_power_plant_swest']-
                                                                                         scalars['leistung_trapfade_bestand'][str(exist_year)]['onshore_wind_power_plant_swest'])),
        ...
        energysystem.add(solph.components.Source(
            ...
            outputs={b_el_in: solph.Flow(fix=sequences['feed_in_profile_2009']['PV_rooftop_north_scaled'],#
                                            ...
                                            investment=solph.Investment(
                                                                        ...
                                                                        # existing= (scalars['leistung_trapfade_bestand'][str(exist_year)]['rooftop_photovoltaic_power_plant_north']
                                                                        #            if is_existing_year else 0),
                                                                        minimum = (None if not is_opt_year 
                                                                                   else (scalars['leistung_trapfade_bestand'][str(YEAR-5)]['rooftop_photovoltaic_power_plant_north']-
                                                                                         scalars['leistung_trapfade_bestand'][str(exist_year)]['rooftop_photovoltaic_power_plant_north'])),
                                                                        maximum=scalars['Parameter_rooftop_photovoltaic_power_plant']['potential_north_max'][model_ID]
        ...
        energysystem.add(solph.components.Source(
            ...
            outputs={b_el_in: solph.Flow(fix=sequences['feed_in_profile_2009']['PV_rooftop_east_scaled'],#
                                            ...
                                            investment=solph.Investment(
                                                                        ep_costs=epc_costs['rooftop_photovoltaic_power_plant']['epc'], 
                                                                        # existing= (scalars['leistung_trapfade_bestand'][str(exist_year)]['rooftop_photovoltaic_power_plant_east']
                                                                        #            if is_existing_year else 0),
                                                                        minimum = (None if not is_opt_year 
                                                                                   else (scalars['leistung_trapfade_bestand'][str(YEAR-5)]['rooftop_photovoltaic_power_plant_east']-
                                                                                         scalars['leistung_trapfade_bestand'][str(exist_year)]['rooftop_photovoltaic_power_plant_east'])),
                                                                        maximum=scalars['Parameter_rooftop_photovoltaic_power_plant']['potential_east_max'][model_ID]
        ...
        energysystem.add(solph.components.Source(
            ...
            outputs={b_el_in: solph.Flow(fix=sequences['feed_in_profile_2009']['PV_rooftop_middle_scaled'],#
                                            ...
                                            investment=solph.Investment(
                                                                        ep_costs=epc_costs['rooftop_photovoltaic_power_plant']['epc'], 
                                                                        # existing= (scalars['leistung_trapfade_bestand'][str(exist_year)]['rooftop_photovoltaic_power_plant_middle']
                                                                        #            if is_existing_year else 0),
                                                                        minimum = (None if not is_opt_year 
                                                                                   else (scalars['leistung_trapfade_bestand'][str(YEAR-5)]['rooftop_photovoltaic_power_plant_middle']-
                                                                                         scalars['leistung_trapfade_bestand'][str(exist_year)]['rooftop_photovoltaic_power_plant_middle'])),
                                                                        maximum=scalars['Parameter_rooftop_photovoltaic_power_plant']['potential_middle_max'][model_ID]
        ...
        energysystem.add(solph.components.Source(
            ...
            outputs={b_el_in: solph.Flow(fix=sequences['feed_in_profile_2009']['PV_rooftop_swest_scaled'],#
                                            ...
                                            investment=solph.Investment(
                                                                        ep_costs=epc_costs['rooftop_photovoltaic_power_plant']['epc'], 
                                                                        # existing= (scalars['leistung_trapfade_bestand'][str(exist_year)]['rooftop_photovoltaic_power_plant_swest']
                                                                        #            if is_existing_year else 0),
                                                                        minimum = (None if not is_opt_year 
                                                                                   else (scalars['leistung_trapfade_bestand'][str(YEAR-5)]['rooftop_photovoltaic_power_plant_swest']-
                                                                                         scalars['leistung_trapfade_bestand'][str(exist_year)]['rooftop_photovoltaic_power_plant_swest'])),
                                                                        maximum=scalars['Parameter_rooftop_photovoltaic_power_plant']['potential_swest_max'][model_ID]
        ...
        energysystem.add(solph.components.Source(
            ...
            outputs={b_el_in: solph.Flow(fix=sequences['feed_in_profile_2009']['PV_openfield_north_scaled'],#
                                            ...
                                            investment=solph.Investment(
                                                                        ...
                                                                        # existing= (scalars['leistung_trapfade_bestand'][str(exist_year)]['field_photovoltaic_power_plant_north']
                                                                        #            if is_existing_year else 0),
                                                                        minimum = (None if not is_opt_year 
                                                                                   else (scalars['leistung_trapfade_bestand'][str(YEAR-5)]['field_photovoltaic_power_plant_north']-
                                                                                         scalars['leistung_trapfade_bestand'][str(exist_year)]['field_photovoltaic_power_plant_north'])),
                                                                        maximum=scalars['Parameter_field_photovoltaic_power_plant']['potential_north_max'][model_ID]
        ...
        energysystem.add(solph.components.Source(
            ...
            outputs={b_el_in: solph.Flow(fix=sequences['feed_in_profile_2009']['PV_openfield_east_scaled'],#
                                            ...
                                            investment=solph.Investment(
                                                                        ep_costs=epc_costs['field_photovoltaic_power_plant']['epc'], 
                                                                        # existing= (scalars['leistung_trapfade_bestand'][str(exist_year)]['field_photovoltaic_power_plant_east']
                                                                        #            if is_existing_year else 0),
                                                                        minimum = (None if not is_opt_year 
                                                                                   else (scalars['leistung_trapfade_bestand'][str(YEAR-5)]['field_photovoltaic_power_plant_east']-
                                                                                         scalars['leistung_trapfade_bestand'][str(exist_year)]['field_photovoltaic_power_plant_east'])),
                                                                        maximum=scalars['Parameter_field_photovoltaic_power_plant']['potential_east_max'][model_ID]
        ...
        energysystem.add(solph.components.Source(
            ...
            outputs={b_el_in: solph.Flow(fix=sequences['feed_in_profile_2009']['PV_openfield_middle_scaled'],#
                                            ...
                                            investment=solph.Investment(
                                                                        ep_costs=epc_costs['field_photovoltaic_power_plant']['epc'], 
                                                                        # existing= (scalars['leistung_trapfade_bestand'][str(exist_year)]['field_photovoltaic_power_plant_middle']
                                                                        #            if is_existing_year else 0),
                                                                        minimum = (None if not is_opt_year 
                                                                                   else (scalars['leistung_trapfade_bestand'][str(YEAR-5)]['field_photovoltaic_power_plant_middle']-
                                                                                         scalars['leistung_trapfade_bestand'][str(exist_year)]['field_photovoltaic_power_plant_middle'])),
                                                                        maximum=scalars['Parameter_field_photovoltaic_power_plant']['potential_middle_max'][model_ID]
        ...
        energysystem.add(solph.components.Source(
            ...
            outputs={b_el_in: solph.Flow(fix=sequences['feed_in_profile_2009']['PV_openfield_swest_scaled'],#
                                            ...
                                            investment=solph.Investment(
                                                                        ep_costs=epc_costs['field_photovoltaic_power_plant']['epc'], 
                                                                        # existing= (scalars['leistung_trapfade_bestand'][str(exist_year)]['field_photovoltaic_power_plant_swest']
                                                                        #            if is_existing_year else 0),
                                                                        minimum = (None if not is_opt_year 
                                                                                   else (scalars['leistung_trapfade_bestand'][str(YEAR-5)]['field_photovoltaic_power_plant_swest']-
                                                                                         scalars['leistung_trapfade_bestand'][str(exist_year)]['field_photovoltaic_power_plant_swest'])),
                                                                        maximum=scalars['Parameter_field_photovoltaic_power_plant']['potential_swest_max'][model_ID]
    ...
    energysystem.add(solph.components.Source(
        ...
        outputs={b_dist_heat: solph.Flow(fix=sequences['feed_in_profile_2009']['Solarthermal'], 
                                          ...
                                          investment=solph.Investment(ep_costs=epc_costs['solar_thermal_power_plant']['epc'],
                                                                      # existing= (scalars['leistung_trapfade_bestand'][str(exist_year)]['solar_thermal_power_plant']
                                                                      #            if is_existing_year else 0),
                                                                      minimum = (None if not is_opt_year 
                                                                                 else (scalars['leistung_trapfade_bestand'][str(YEAR-5)]['solar_thermal_power_plant']-
                                                                                       scalars['leistung_trapfade_bestand'][str(exist_year)]['solar_thermal_power_plant'])),
    ...
    energysystem.add(solph.components.Converter(
        ...
        outputs={b_gas: solph.Flow(fix=sequences['Base_demand_profile']['base_load'],
                                   investment = solph.Investment(
                                       ...
                                       minimum = (None if not is_opt_year 
                                                  else (scalars['leistung_trapfade_bestand'][str(YEAR-5)]['biogas_upgrading_plant']-
                                                        scalars['leistung_trapfade_bestand'][str(exist_year)]['biogas_upgrading_plant'])),
    ...
    energysystem.add(solph.components.Converter(
        ...
        outputs={b_oil_fuel: solph.Flow(investment = solph.Investment(ep_costs=epc_costs['biomass_to_liquid_system_substrat']['epc'], 
                                                                      minimum = (None if not is_opt_year 
                                                                                 else (scalars['leistung_trapfade_bestand'][str(YEAR-5)]['biomass_to_liquid_system_substrat']-
                                                                                       scalars['leistung_trapfade_bestand'][str(exist_year)]['biomass_to_liquid_system_substrat']))
                                                                              #maximum=scalars['Parameter_biomass_to_liquid_system']['potential'][model_ID]
                                                                              ),
    ...
    energysystem.add(solph.components.Converter(
        ...
        outputs={b_el_in: solph.Flow(investment = solph.Investment(ep_costs=epc_costs['fuel_cells']['epc'], 
                                                                   minimum = (None if not is_opt_year 
                                                                              else (scalars['leistung_trapfade_bestand'][str(YEAR-5)]['fuel_cells']-
                                                                              scalars['leistung_trapfade_bestand'][str(exist_year)]['fuel_cells'])),
    ...
    energysystem.add(solph.components.Converter(
        ...
        outputs={b_gas: solph.Flow(investment = solph.Investment(ep_costs=epc_costs['methanation']['epc'], 
                                                                 minimum = (None if not is_opt_year 
                                                                            else (scalars['leistung_trapfade_bestand'][str(YEAR-5)]['methanation']-
                                                                                  scalars['leistung_trapfade_bestand'][str(exist_year)]['methanation'])),
    ...
    energysystem.add(solph.components.Converter(
        ...
        outputs={b_oil_fuel: solph.Flow(investment = solph.Investment(ep_costs=epc_costs['power_to_liquid_system']['epc'], 
                                                                      minimum = (None if not is_opt_year 
                                                                                 else (scalars['leistung_trapfade_bestand'][str(YEAR-5)]['power_to_liquid_system']-
                                                                                       scalars['leistung_trapfade_bestand'][str(exist_year)]['power_to_liquid_system'])),
    ...
    energysystem.add(solph.components.Converter(
        ...
        outputs={b_el_in: solph.Flow(investment=solph.Investment(ep_costs=epc_costs['combined_heat_and_power_generating_unit']['epc'],
                                                                 # existing= (scalars['leistung_trapfade_bestand'][str(exist_year)]['combined_heat_and_power_generating_unit']
                                                                 #            if is_existing_year else 0),
                                                                 minimum = (None if not is_opt_year 
                                                                            else (scalars['leistung_trapfade_bestand'][str(YEAR-5)]['combined_heat_and_power_generating_unit']-
                                                                                  scalars['leistung_trapfade_bestand'][str(exist_year)]['combined_heat_and_power_generating_unit'])),
    ...
    energysystem.add(solph.components.Converter(
        ...
        outputs={b_dist_heat: solph.Flow(#fix=sequences['Base_demand_profile']['base_load'],
                                    investment=solph.Investment(ep_costs=epc_costs['biomass_heating_plant']['epc'],
                                                                # existing= (scalars['leistung_trapfade_bestand'][str(exist_year)]['biomass_heating_plant']
                                                                #            if is_existing_year else 0),
                                                                minimum = (None if not is_opt_year 
                                                                           else (scalars['leistung_trapfade_bestand'][str(YEAR-5)]['biomass_heating_plant']-
                                                                                 scalars['leistung_trapfade_bestand'][str(exist_year)]['biomass_heating_plant'])),
    ...
    energysystem.add(solph.components.Converter(
        ...
        outputs={b_el_in: solph.Flow(#fix=sequences['Base_demand_profile']['base_load'],
                                  investment=solph.Investment(ep_costs=epc_costs['biomass_combined_heat_and_power_plant']['epc'] ,
                                                              # existing= (scalars['leistung_trapfade_bestand'][str(exist_year)]['biomass_combined_heat_and_power_plant']
                                                              #            if is_existing_year else 0),
                                                              minimum = (None if not is_opt_year 
                                                                         else (scalars['leistung_trapfade_bestand'][str(YEAR-5)]['biomass_combined_heat_and_power_plant']-
                                                                               scalars['leistung_trapfade_bestand'][str(exist_year)]['biomass_combined_heat_and_power_plant'])),
    ...
    energysystem.add(solph.components.Converter(
        ...
        outputs={b_dist_heat: solph.Flow(investment = solph.Investment(ep_costs=epc_costs['electrical_heater']['epc'],
                                                                       minimum = (None if not is_opt_year 
                                                                                  else (scalars['leistung_trapfade_bestand'][str(YEAR-5)]['electrical_heater']-
                                                                                        scalars['leistung_trapfade_bestand'][str(exist_year)]['electrical_heater'])),
                                                                       ))},
    ...
    energysystem.add(solph.components.Converter(
        ...
        outputs={b_dist_heat: solph.Flow(investment = solph.Investment(
            ep_costs=epc_costs['heat_pump_air_Umgebungswärme']['epc'],
                                        # existing= (scalars['leistung_trapfade_bestand'][str(exist_year)]['heat_pump_air_Umgebungswärme']
                                        #            if is_existing_year else 0),
                                       minimum = (None if not is_opt_year 
                                                  else (scalars['leistung_trapfade_bestand'][str(YEAR-5)]['heat_pump_air_Umgebungswärme']-
                                                        scalars['leistung_trapfade_bestand'][str(exist_year)]['heat_pump_air_Umgebungswärme'])),
    ...
    energysystem.add(solph.components.Converter(
        ...
        outputs={b_H2: solph.Flow(investment = solph.Investment(ep_costs=epc_costs['electrolysis']['epc'], 
                                                                minimum = (None if not is_opt_year 
                                                                           else (scalars['leistung_trapfade_bestand'][str(YEAR-5)]['electrolysis']-
                                                                                 scalars['leistung_trapfade_bestand'][str(exist_year)]['electrolysis'])),
    ...
    energysystem.add(solph.components.Converter(
        ...
        outputs={b_dist_heat: solph.Flow(investment = solph.Investment(ep_costs= epc_costs['electrical_heater']['epc'], 
                                                                       minimum = (None if not is_opt_year 
                                                                                  else (scalars['leistung_trapfade_bestand'][str(YEAR-5)]['preheater_electric_boiler']-
                                                                                        scalars['leistung_trapfade_bestand'][str(exist_year)]['preheater_electric_boiler'])),
                                                                  #maximum=scalars['Parameter_electrolysis']['potential'][model_ID]
                                                                  ))},
        conversion_factors={b_el_out: 1 - (T_seaso_speicher/T_VL),
                            b_preheat: (T_seaso_speicher/T_VL)
    ...
    energysystem.add(solph.components.GenericStorage(
        ...
        investment = solph.Investment(ep_costs=epc_costs['storage_electricity']['epc'],
                                    # existing= (scalars['leistung_trapfade_bestand'][str(exist_year)]['storage_electricity']
                                    #            if is_existing_year else 0),
                                    minimum = (None if not is_opt_year 
                                               else (scalars['leistung_trapfade_bestand'][str(YEAR-5)]['storage_electricity']-
                                                     scalars['leistung_trapfade_bestand'][str(exist_year)]['storage_electricity'])),
    ...
    energysystem.add(solph.components.GenericStorage(
        ...
        investment = solph.Investment(ep_costs=epc_costs['storage_electricity_Li-Ion']['epc'],
                                    # existing= (scalars['leistung_trapfade_bestand'][str(exist_year)]['storage_electricity_Li-Ion']
                                    #            if is_existing_year else 0),
                                    minimum = (None if not is_opt_year 
                                               else (scalars['leistung_trapfade_bestand'][str(YEAR-5)]['storage_electricity_Li-Ion']-
                                                     scalars['leistung_trapfade_bestand'][str(exist_year)]['storage_electricity_Li-Ion'])),
    ...
    energysystem.add(solph.components.GenericStorage(
        ...
        nominal_storage_capacity = solph.Investment(ep_costs=epc_costs['storage_heat_district_heating']['epc'],
                                                    minimum = (None if not is_opt_year 
                                                               else (scalars['leistung_trapfade_bestand'][str(YEAR-5)]['storage_heat_district_heating']-
                                                                     scalars['leistung_trapfade_bestand'][str(exist_year)]['storage_heat_district_heating'])),
    ...
    energysystem.add(solph.components.GenericStorage(
        ...
        nominal_storage_capacity = solph.Investment(ep_costs=epc_costs['storage_heat_seasonal']['epc'], 
                                                    minimum = (None if not is_opt_year 
                                                               else (scalars['leistung_trapfade_bestand'][str(YEAR-5)]['storage_heat_seasonal']-
                                                                     scalars['leistung_trapfade_bestand'][str(exist_year)]['storage_heat_seasonal'])),
    ...
    energysystem.add(solph.components.GenericStorage(
        ...
        investment = solph.Investment(ep_costs=epc_costs['storage_gas']['epc'], 
                                      minimum = (None if not is_opt_year 
                                                 else (scalars['leistung_trapfade_bestand'][str(YEAR-5)]['storage_gas']-
                                                       scalars['leistung_trapfade_bestand'][str(exist_year)]['storage_gas'])),
                                      maximum=scalars['Parameter_storage_gas']['potential_total'][model_ID] 
    ...
    energysystem.add(solph.components.GenericStorage(
        ...
        investment = solph.Investment(ep_costs=epc_costs['storage_hydrogen']['epc'], 
                                      minimum = (None if not is_opt_year 
                                                 else (scalars['leistung_trapfade_bestand'][str(YEAR-5)]['storage_hydrogen']-
                                                       scalars['leistung_trapfade_bestand'][str(exist_year)]['storage_hydrogen'])),
