# -*- coding: utf-8 -*-
"""
Created on Wed Jun 24 08:44:48 2026
...
def Basisszenario_pathway_B(PERMUATION: str) -> solph.EnergySystem:
    YEAR, model_ID = PERMUATION.split("_")
    YEAR = int(YEAR)
    is_existing_year = YEAR in [2020, 2025,2030, 2035]
    
    if YEAR == 2045:
        exist_year =YEAR
    else:
        exist_year = 2025
    is_opt_year = YEAR in[2035,2040,2045]
    ...
    energysystem.add(b_el_in, b_el_out, b_gas, b_oil_fuel, b_bio, b_bioWood, b_dist_heat, b_H2, b_solidf, b_abwaerme, b_uw, b_hös, b_preheat, b_pumps, b_umgebungsluft)
    ...
    if feed_in_profile_new:
        ...
        energysystem.add(solph.components.Source(
            label='Wind_north', 
            outputs={b_el_in: solph.Flow(fix=north.Wind_feed_in_profile['Wind_feed_in'],
        ...
        energysystem.add(solph.components.Source(
            label='Wind_east', 
            outputs={b_el_in: solph.Flow(fix=east.Wind_feed_in_profile['Wind_feed_in'],
                                            custom_attributes={'emission_factor': scalars['Parameter_onshore_wind_power_plant']['EE_factor'][model_ID]},
                                            investment=solph.Investment(ep_costs=epc_costs['onshore_wind_power_plant']['epc'], 
        ...
        energysystem.add(solph.components.Source(
            label='Wind_middle', 
            outputs={b_el_in: solph.Flow(fix=middle.Wind_feed_in_profile['Wind_feed_in'],
                                            custom_attributes={'emission_factor': scalars['Parameter_onshore_wind_power_plant']['EE_factor'][model_ID]},
                                            investment=solph.Investment(ep_costs=epc_costs['onshore_wind_power_plant']['epc'], 
        ...
        energysystem.add(solph.components.Source(
            label='Wind_swest', 
            outputs={b_el_in: solph.Flow(fix=swest.Wind_feed_in_profile['Wind_feed_in'],
                                            custom_attributes={'emission_factor': scalars['Parameter_onshore_wind_power_plant']['EE_factor'][model_ID]},
                                            investment=solph.Investment(ep_costs=epc_costs['onshore_wind_power_plant']['epc'], 
        ...
        energysystem.add(solph.components.Source(
            ...
            outputs={b_el_in: solph.Flow(fix=north.PV_feed_in_profile_rooftop['AC_Power'],
        ...
        energysystem.add(solph.components.Source(
            ...
            outputs={b_el_in: solph.Flow(fix=east.PV_feed_in_profile_rooftop['AC_Power'],
                                            custom_attributes={'emission_factor': scalars['Parameter_rooftop_photovoltaic_power_plant']['EE_factor'][model_ID]},
                                            investment=solph.Investment(ep_costs=epc_costs['rooftop_photovoltaic_power_plant']['epc'], 
        ...
        energysystem.add(solph.components.Source(
            ...
            outputs={b_el_in: solph.Flow(fix=middle.PV_feed_in_profile_rooftop['AC_Power'],
                                            custom_attributes={'emission_factor': scalars['Parameter_rooftop_photovoltaic_power_plant']['EE_factor'][model_ID]},
                                            investment=solph.Investment(ep_costs=epc_costs['rooftop_photovoltaic_power_plant']['epc'], 
        ...
        energysystem.add(solph.components.Source(
            ...
            outputs={b_el_in: solph.Flow(fix=swest.PV_feed_in_profile_rooftop['AC_Power'],
                                            custom_attributes={'emission_factor': scalars['Parameter_rooftop_photovoltaic_power_plant']['EE_factor'][model_ID]},
                                            investment=solph.Investment(ep_costs=epc_costs['rooftop_photovoltaic_power_plant']['epc'], 
        ...
        energysystem.add(solph.components.Source(
            label='PV_open_north', 
            outputs={b_el_in: solph.Flow(fix=north.PV_feed_in_profile_openfield['AC_Power'],
        ...
        energysystem.add(solph.components.Source(
            label='PV_open_east', 
            outputs={b_el_in: solph.Flow(fix=east.PV_feed_in_profile_openfield['AC_Power'],
                                            custom_attributes={'emission_factor': scalars['Parameter_field_photovoltaic_power_plant']['EE_factor'][model_ID]},
                                            investment=solph.Investment(ep_costs=epc_costs['field_photovoltaic_power_plant']['epc'], 
        ...
        energysystem.add(solph.components.Source(
            ...
            outputs={b_el_in: solph.Flow(fix=middle.PV_feed_in_profile_openfield['AC_Power'],
                                            custom_attributes={'emission_factor': scalars['Parameter_field_photovoltaic_power_plant']['EE_factor'][model_ID]},
                                            investment=solph.Investment(ep_costs=epc_costs['field_photovoltaic_power_plant']['epc'], 
        ...
        energysystem.add(solph.components.Source(
            label='PV_open_swest', 
            outputs={b_el_in: solph.Flow(fix=swest.PV_feed_in_profile_openfield['AC_Power'],
                                            custom_attributes={'emission_factor': scalars['Parameter_field_photovoltaic_power_plant']['EE_factor'][model_ID]},
                                            investment=solph.Investment(ep_costs=epc_costs['field_photovoltaic_power_plant']['epc'], 
        ...
        energysystem.add(solph.components.Source(
            ...
            outputs={b_el_in: solph.Flow(fix=sequences['feed_in_profile_2009']['Wind_north_scaled'],
                                            ...
                                            investment=solph.Investment(
                                                                        ...
                                                                        # existing= (scalars['leistung_trapfade_backward'][str(exist_year)]['onshore_wind_power_plant_north']),
                                                                        maximum=scalars['Parameter_onshore_wind_power_plant']['potential_north_max_'+ str(YEAR)][model_ID]
                                                                        # maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['onshore_wind_power_plant_north'] if not is_# existing_year
                                                                        #            else abs (scalars['leistung_trapfade_backward'][str(YEAR+5)]['onshore_wind_power_plant_north']-
                                                                        #            scalars['leistung_trapfade_backward'][str(exist_year)]['onshore_wind_power_plant_north'])),
                                                                         )
            )}))
        ...
        energysystem.add(solph.components.Source(
            ...
            outputs={b_el_in: solph.Flow(fix=sequences['feed_in_profile_2009']['Wind_east_scaled'],#
                                            ...
                                            investment=solph.Investment(
                                                                        ep_costs=epc_costs['onshore_wind_power_plant']['epc'] , 
                                                                        # existing= (scalars['leistung_trapfade_backward'][str(exist_year)]['onshore_wind_power_plant_east']),
                                                                        maximum=scalars['Parameter_onshore_wind_power_plant']['potential_east_max_'+ str(YEAR)][model_ID]
                                                                        # maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['onshore_wind_power_plant_east'] if not is_existing_year
                                                                        #            else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['onshore_wind_power_plant_east']-
                                                                        #            scalars['leistung_trapfade_backward'][str(exist_year)]['onshore_wind_power_plant_east'])),
        ...
        energysystem.add(solph.components.Source(
            ...
            outputs={b_el_in: solph.Flow(fix=sequences['feed_in_profile_2009']['Wind_middle_scaled'],#
                                            ...
                                            investment=solph.Investment(
                                                                        ep_costs=epc_costs['onshore_wind_power_plant']['epc'] , 
                                                                         # existing= (scalars['leistung_trapfade_backward'][str(exist_year)]['onshore_wind_power_plant_middle'] ),
                                                                         maximum=scalars['Parameter_onshore_wind_power_plant']['potential_middle_max_'+ str(YEAR)][model_ID]
                                                                        # maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['onshore_wind_power_plant_middle'] if not is_existing_year
                                                                        #            else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['onshore_wind_power_plant_middle']-
                                                                        #            scalars['leistung_trapfade_backward'][str(exist_year)]['onshore_wind_power_plant_middle'])),
        ...
        energysystem.add(solph.components.Source(
            ...
            outputs={b_el_in: solph.Flow(fix=sequences['feed_in_profile_2009']['Wind_swest_scaled'],#
                                            ...
                                            investment=solph.Investment(
                                                                        ep_costs=epc_costs['onshore_wind_power_plant']['epc'], 
                                                                        # existing= (scalars['leistung_trapfade_backward'][str(exist_year)]['onshore_wind_power_plant_swest']),
                                                                        maximum=scalars['Parameter_onshore_wind_power_plant']['potential_swest_max_'+ str(YEAR)][model_ID]
                                                                        # maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['onshore_wind_power_plant_swest'] if not is_existing_year
                                                                        #            else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['onshore_wind_power_plant_swest']-
                                                                        #            scalars['leistung_trapfade_backward'][str(exist_year)]['onshore_wind_power_plant_swest'])),
        ...
        energysystem.add(solph.components.Source(
            ...
            outputs={b_el_in: solph.Flow(fix=sequences['feed_in_profile_2009']['PV_rooftop_north_scaled'],#
                                            custom_attributes={'emission_factor': scalars['Parameter_rooftop_photovoltaic_power_plant']['EE_factor'][model_ID]},
                                            investment=solph.Investment(
                                                                        ep_costs=epc_costs['rooftop_photovoltaic_power_plant']['epc'], 
                                                                        # existing= (scalars['leistung_trapfade_backward'][str(exist_year)]['rooftop_photovoltaic_power_plant_north'] ),
                                                                        maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['rooftop_photovoltaic_power_plant_north'] if not is_existing_year
                                                                                   else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['rooftop_photovoltaic_power_plant_north']-
                                                                                   scalars['leistung_trapfade_backward'][str(exist_year)]['rooftop_photovoltaic_power_plant_north'])),
        ...
        energysystem.add(solph.components.Source(
            ...
            outputs={b_el_in: solph.Flow(fix=sequences['feed_in_profile_2009']['PV_rooftop_east_scaled'],#
                                            ...
                                            investment=solph.Investment(
                                                                        ep_costs=epc_costs['rooftop_photovoltaic_power_plant']['epc'], 
                                                                        # existing= (scalars['leistung_trapfade_backward'][str(exist_year)]['rooftop_photovoltaic_power_plant_east'] ),
                                                                        maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['rooftop_photovoltaic_power_plant_east'] if not is_existing_year
                                                                                   else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['rooftop_photovoltaic_power_plant_east']-
                                                                                   scalars['leistung_trapfade_backward'][str(exist_year)]['rooftop_photovoltaic_power_plant_east'])),
        ...
        energysystem.add(solph.components.Source(
            ...
            outputs={b_el_in: solph.Flow(fix=sequences['feed_in_profile_2009']['PV_rooftop_middle_scaled'],#
                                            ...
                                            investment=solph.Investment(
                                                                        ep_costs=epc_costs['rooftop_photovoltaic_power_plant']['epc'], 
                                                                        # existing= (scalars['leistung_trapfade_backward'][str(exist_year)]['rooftop_photovoltaic_power_plant_middle'] ),
                                                                        maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['rooftop_photovoltaic_power_plant_middle'] if not is_existing_year
                                                                                   else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['rooftop_photovoltaic_power_plant_middle']-
                                                                                   scalars['leistung_trapfade_backward'][str(exist_year)]['rooftop_photovoltaic_power_plant_middle'])),
        ...
        energysystem.add(solph.components.Source(
            ...
            outputs={b_el_in: solph.Flow(fix=sequences['feed_in_profile_2009']['PV_rooftop_swest_scaled'],#
                                            ...
                                            investment=solph.Investment(
                                                                        ep_costs=epc_costs['rooftop_photovoltaic_power_plant']['epc'], 
                                                                        # existing= (scalars['leistung_trapfade_backward'][str(exist_year)]['rooftop_photovoltaic_power_plant_swest']),
                                                                        maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['rooftop_photovoltaic_power_plant_swest'] if not is_existing_year
                                                                                   else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['rooftop_photovoltaic_power_plant_swest']-
                                                                                   scalars['leistung_trapfade_backward'][str(exist_year)]['rooftop_photovoltaic_power_plant_swest'])),
        ...
        energysystem.add(solph.components.Source(
            ...
            outputs={b_el_in: solph.Flow(fix=sequences['feed_in_profile_2009']['PV_openfield_north_scaled'],#
                                            custom_attributes={'emission_factor': scalars['Parameter_field_photovoltaic_power_plant']['EE_factor'][model_ID]},
                                            investment=solph.Investment(
                                                                        ep_costs=epc_costs['field_photovoltaic_power_plant']['epc'], 
                                                                        # existing= (scalars['leistung_trapfade_backward'][str(exist_year)]['field_photovoltaic_power_plant_north']),
                                                                        maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['field_photovoltaic_power_plant_north'] if not is_existing_year
                                                                                   else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['field_photovoltaic_power_plant_north']-
                                                                                   scalars['leistung_trapfade_backward'][str(exist_year)]['field_photovoltaic_power_plant_north'])),
        ...
        energysystem.add(solph.components.Source(
            ...
            outputs={b_el_in: solph.Flow(fix=sequences['feed_in_profile_2009']['PV_openfield_east_scaled'],#
                                            ...
                                            investment=solph.Investment(
                                                                        ep_costs=epc_costs['field_photovoltaic_power_plant']['epc'], 
                                                                        # existing= (scalars['leistung_trapfade_backward'][str(exist_year)]['field_photovoltaic_power_plant_east'] ),
                                                                        maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['field_photovoltaic_power_plant_east'] if not is_existing_year
                                                                                   else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['field_photovoltaic_power_plant_east']-
                                                                                   scalars['leistung_trapfade_backward'][str(exist_year)]['field_photovoltaic_power_plant_east'])),
        ...
        energysystem.add(solph.components.Source(
            ...
            outputs={b_el_in: solph.Flow(fix=sequences['feed_in_profile_2009']['PV_openfield_middle_scaled'],#
                                            ...
                                            investment=solph.Investment(
                                                                        ep_costs=epc_costs['field_photovoltaic_power_plant']['epc'], 
                                                                        # existing= (scalars['leistung_trapfade_backward'][str(exist_year)]['field_photovoltaic_power_plant_middle'] ),
                                                                        maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['field_photovoltaic_power_plant_middle'] if not is_existing_year
                                                                                   else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['field_photovoltaic_power_plant_middle']-
                                                                                   scalars['leistung_trapfade_backward'][str(exist_year)]['field_photovoltaic_power_plant_middle'])),
        ...
        energysystem.add(solph.components.Source(
            ...
            outputs={b_el_in: solph.Flow(fix=sequences['feed_in_profile_2009']['PV_openfield_swest_scaled'],#
                                            ...
                                            investment=solph.Investment(
                                                                        ep_costs=epc_costs['field_photovoltaic_power_plant']['epc'], 
                                                                        # existing= (scalars['leistung_trapfade_backward'][str(exist_year)]['field_photovoltaic_power_plant_swest'] ),
                                                                        maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['field_photovoltaic_power_plant_swest'] if not is_existing_year
                                                                                   else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['field_photovoltaic_power_plant_swest']-
                                                                                   scalars['leistung_trapfade_backward'][str(exist_year)]['field_photovoltaic_power_plant_swest'])),
    ...
    energysystem.add(solph.components.Source(
        ...
        outputs={b_dist_heat: solph.Flow(fix=sequences['feed_in_profile_2009']['Solarthermal'], 
                                          ...
                                          investment=solph.Investment(ep_costs=epc_costs['solar_thermal_power_plant']['epc'],
                                                                      # existing= (scalars['leistung_trapfade_backward'][str(exist_year)]['solar_thermal_power_plant']),
                                                                     maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['solar_thermal_power_plant'] if not is_existing_year
                                                                                else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['solar_thermal_power_plant']-
                                                                                scalars['leistung_trapfade_backward'][str(exist_year)]['solar_thermal_power_plant'])),
    ...
    energysystem.add(solph.components.Converter(
        ...
        outputs={b_gas: solph.Flow(fix=sequences['Base_demand_profile']['base_load'],
                                   investment = solph.Investment(
                                       ...
                                       maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['biogas_upgrading_plant'] if not is_existing_year
                                                  else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['biogas_upgrading_plant']-
                                                  scalars['leistung_trapfade_backward'][str(exist_year)]['biogas_upgrading_plant'])),
    ...
    energysystem.add(solph.components.Converter(
        ...
        outputs={b_gas: solph.Flow(fix=sequences['Base_demand_profile']['base_load'],
                                   investment = solph.Investment(ep_costs=epc_costs['biomethane_injection_plant']['epc'],#
                                                                 maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['biomethane_injection_plant'] if not is_existing_year
                                                                            else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['biomethane_injection_plant']-
                                                                            scalars['leistung_trapfade_backward'][str(exist_year)]['biomethane_injection_plant'])),
                                                                 ),
    ...
    energysystem.add(solph.components.Converter(
        ...
        outputs={b_el_in: solph.Flow(investment=solph.Investment(ep_costs=epc_costs['biogas_combined_heat_and_power_plant']['epc'],
                                                                 maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['biogas_combined_heat_and_power_plant'] if not is_existing_year
                                                                            else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['biogas_combined_heat_and_power_plant']-
                                                                            scalars['leistung_trapfade_backward'][str(exist_year)]['biogas_combined_heat_and_power_plant'])),
                                                                 ), 
    ...
    energysystem.add(solph.components.Converter(
        ...
        outputs={b_oil_fuel: solph.Flow(investment = solph.Investment(ep_costs=epc_costs['biomass_to_liquid_system_holz']['epc'], 
                                                                              ...
                                                                              maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['biomass_to_liquid_system_holz'] if not is_existing_year
                                                                                         else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['biomass_to_liquid_system_holz']-
                                                                                         scalars['leistung_trapfade_backward'][str(exist_year)]['biomass_to_liquid_system_holz'])),
                                                                              ),
    ...
    energysystem.add(solph.components.Converter(
        ...
        outputs={b_oil_fuel: solph.Flow(investment = solph.Investment(ep_costs=epc_costs['biomass_to_liquid_system_substrat']['epc'], 
                                                                      maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['biomass_to_liquid_system_substrat'] if not is_existing_year
                                                                                 else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['biomass_to_liquid_system_substrat']-
                                                                                 scalars['leistung_trapfade_backward'][str(exist_year)]['biomass_to_liquid_system_substrat'])),
    ...
    energysystem.add(solph.components.Converter(
        ...
        outputs={b_el_in: solph.Flow(investment = solph.Investment(ep_costs=epc_costs['fuel_cells']['epc'], 
                                                                  maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['fuel_cells'] if not is_existing_year
                                                                             else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['fuel_cells']-
                                                                             scalars['leistung_trapfade_backward'][str(exist_year)]['fuel_cells'])),
    ...
    energysystem.add(solph.components.Converter(
        ...
        outputs={b_gas: solph.Flow(investment = solph.Investment(ep_costs=epc_costs['methanation']['epc'], 
                                                                 maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['methanation'] if not is_existing_year
                                                                            else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['methanation']-
                                                                            scalars['leistung_trapfade_backward'][str(exist_year)]['methanation'])),
    ...
    energysystem.add(solph.components.Converter(
        ...
        outputs={b_oil_fuel: solph.Flow(investment = solph.Investment(ep_costs=epc_costs['power_to_liquid_system']['epc'], 
                                                                     maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['power_to_liquid_system'] if not is_existing_year
                                                                                else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['power_to_liquid_system']-
                                                                                scalars['leistung_trapfade_backward'][str(exist_year)]['power_to_liquid_system'])),
    ...
    energysystem.add(solph.components.Converter(
        ...
        outputs={b_el_in: solph.Flow(investment=solph.Investment(ep_costs=epc_costs['combined_heat_and_power_generating_unit']['epc'],
                                                                 # existing= (scalars['leistung_trapfade_backward'][str(exist_year)]['combined_heat_and_power_generating_unit'] ),
                                                                maximum = 0, # wegen zero Leistung im 2045
                                                              )),
    ...
    energysystem.add(solph.components.Converter(
        ...
        outputs={b_el_in: solph.Flow(#fix=sequences['Base_demand_profile']['base_load'],
                                  investment=solph.Investment(ep_costs=epc_costs['biomass_power_plant']['epc'],
                                                              maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['biomass_power_plant'] if not is_existing_year
                                                                         else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['biomass_power_plant']-
                                                                         scalars['leistung_trapfade_backward'][str(exist_year)]['biomass_power_plant'])),
                                                              ),
    ...
    energysystem.add(solph.components.Converter(
        ...
        outputs={b_dist_heat: solph.Flow(#fix=sequences['Base_demand_profile']['base_load'],
                                    investment=solph.Investment(ep_costs=epc_costs['biomass_heating_plant']['epc'],
                                                                ...
                                                                # existing (scalars['leistung_trapfade_backward'][str(exist_year)]['biomass_heating_plant']),
                                                                maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['biomass_heating_plant'] if not is_existing_year
                                                                           else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['biomass_heating_plant']-
                                                                           scalars['leistung_trapfade_backward'][str(exist_year)]['biomass_heating_plant'])),
    ...
    energysystem.add(solph.components.Converter(
        ...
        outputs={b_el_in: solph.Flow(#fix=sequences['Base_demand_profile']['base_load'],
                                  investment=solph.Investment(ep_costs=epc_costs['biomass_combined_heat_and_power_plant']['epc'] ,
                                                              # existing (scalars['leistung_trapfade_backward'][str(exist_year)]['biomass_combined_heat_and_power_plant'] ),
                                                              maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['biomass_combined_heat_and_power_plant'] if not is_existing_year
                                                                         else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['biomass_combined_heat_and_power_plant']-
                                                                         scalars['leistung_trapfade_backward'][str(exist_year)]['biomass_combined_heat_and_power_plant'])),
    ...
    energysystem.add(solph.components.Converter(
        ...
        outputs={b_dist_heat: solph.Flow(investment = solph.Investment(ep_costs=epc_costs['electrical_heater']['epc'],
                                                                       maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['electrical_heater'] if not is_existing_year
                                                                                  else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['electrical_heater']-
                                                                                  scalars['leistung_trapfade_backward'][str(exist_year)]['electrical_heater'])),
                                                                       ))},
    ...
    energysystem.add(solph.components.Converter(
        ...
        outputs={b_dist_heat: solph.Flow(investment = solph.Investment(
            ep_costs=epc_costs['heat_pump_air_Umgebungswärme']['epc'],
                                        # existing (scalars['leistung_trapfade_backward'][str(exist_year)]['heat_pump_air_Umgebungswärme'] ),
                                        maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['heat_pump_air_Umgebungswärme'] if not is_existing_year
                                                   else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['heat_pump_air_Umgebungswärme']-
                                                   scalars['leistung_trapfade_backward'][str(exist_year)]['heat_pump_air_Umgebungswärme'])),
    ...
    energysystem.add(solph.components.Converter(
        ...
        outputs={b_dist_heat: solph.Flow(investment = solph.Investment(
            ...
            maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['heat_pump_ground_Flusswärme'] if not is_existing_year
                       else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['heat_pump_ground_Flusswärme']-
                       scalars['leistung_trapfade_backward'][str(exist_year)]['heat_pump_ground_Flusswärme'])),
    ...
    energysystem.add(solph.components.Converter(
        ...
        outputs={b_dist_heat: solph.Flow(investment = solph.Investment(
            ...
            maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['heat_pump_air_Abwärme'] if not is_existing_year
                       else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['heat_pump_air_Abwärme']-
                       scalars['leistung_trapfade_backward'][str(exist_year)]['heat_pump_air_Abwärme'])),
            
            # maximum = scalars['Parameter_heat_pump_air_Abwärme']['potential_total'][model_ID]
            ))},
        # conversion_factors={b_dist_heat: COP},
        conversion_factors={b_el_out: 1/scalars['Parameter_heat_pump_air_Abwärme']['efficiency_'+str(YEAR)][model_ID],
                            b_abwaerme: (scalars['Parameter_heat_pump_air_Abwärme']['efficiency_'+str(YEAR)][model_ID]-1)/scalars[
    ...
    energysystem.add(solph.components.Converter(
        ...
        outputs={b_H2: solph.Flow(investment = solph.Investment(ep_costs=epc_costs['electrolysis']['epc'], 
                                                                maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['electrolysis'] if not is_existing_year
                                                                           else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['electrolysis']-
                                                                           scalars['leistung_trapfade_backward'][str(exist_year)]['electrolysis'])),
    ...
    energysystem.add(solph.components.Converter(
        ...
        inputs={b_el_out: solph.Flow(),
                b_preheat: solph.Flow()},
        outputs={b_dist_heat: solph.Flow(investment = solph.Investment(ep_costs= epc_costs['electrical_heater']['epc'], 
                                                                      maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['preheater_electric_boiler'] if not is_existing_year
                                                                                 else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['preheater_electric_boiler']-
                                                                                 scalars['leistung_trapfade_backward'][str(exist_year)]['preheater_electric_boiler'])),
                                                                  #maximum=scalars['Parameter_electrolysis']['potential'][model_ID]
                                                                  ))},
        conversion_factors={b_el_out: 1 - (T_seaso_speicher/T_VL),
                            b_preheat: (T_seaso_speicher/T_VL)
    ...
    energysystem.add(solph.components.GenericStorage(
        ...
        investment = solph.Investment(ep_costs=epc_costs['storage_electricity']['epc'],
                                    # existing (scalars['leistung_trapfade_backward'][str(exist_year)]['storage_electricity'] ),
                                    maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['storage_electricity'] if not is_existing_year
                                               else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['storage_electricity']-
                                               scalars['leistung_trapfade_backward'][str(exist_year)]['storage_electricity'])),
    ...
    energysystem.add(solph.components.GenericStorage(
        ...
        investment = solph.Investment(ep_costs=epc_costs['storage_electricity_Li-Ion']['epc'],
                                    # existing (scalars['leistung_trapfade_backward'][str(exist_year)]['storage_electricity_Li-Ion'] ),
                                   maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['storage_electricity_Li-Ion'] if not is_existing_year
                                              else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['storage_electricity_Li-Ion']-
                                              scalars['leistung_trapfade_backward'][str(exist_year)]['storage_electricity_Li-Ion'])),
    ...
    energysystem.add(solph.components.GenericStorage(
        ...
        investment = solph.Investment(ep_costs=epc_costs['storage_electricity_Natrium']['epc'], 
                                      maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['storage_electricity_Natrium'] if not is_existing_year
                                                 else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['storage_electricity_Natrium']-
                                                 scalars['leistung_trapfade_backward'][str(exist_year)]['storage_electricity_Natrium'])),
    ...
    energysystem.add(solph.components.GenericStorage(
        ...
        investment = solph.Investment(ep_costs=epc_costs['storage_electricity_Red-OX']['epc'], 
                                      maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['storage_electricity_Red-OX'] if not is_existing_year
                                                 else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['storage_electricity_Red-OX']-
                                                 scalars['leistung_trapfade_backward'][str(exist_year)]['storage_electricity_Red-OX'])),
    ...
    energysystem.add(solph.components.GenericStorage(
        ...
        nominal_storage_capacity = solph.Investment(ep_costs=epc_costs['storage_heat_district_heating']['epc'],
                                                   maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['storage_heat_district_heating'] if not is_existing_year
                                                              else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['storage_heat_district_heating']-
                                                              scalars['leistung_trapfade_backward'][str(exist_year)]['storage_heat_district_heating'])),
    ...
    energysystem.add(solph.components.GenericStorage(
        ...
        nominal_storage_capacity = solph.Investment(ep_costs=epc_costs['storage_heat_seasonal']['epc'], 
                                                    maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['storage_heat_seasonal'] if not is_existing_year
                                                               else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['storage_heat_seasonal']-
                                                               scalars['leistung_trapfade_backward'][str(exist_year)]['storage_heat_seasonal'])),
    ...
    energysystem.add(solph.components.GenericStorage(
        ...
        investment = solph.Investment(ep_costs=epc_costs['storage_gas']['epc'], 
                                      maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['storage_gas'] if not is_existing_year
                                                 else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['storage_gas']-
                                                 scalars['leistung_trapfade_backward'][str(exist_year)]['storage_gas'])),
                                      )  # is the same value for all region in the csv file, that's why as Potential_north, the capacity is not yet regionalised
        ))
    ...
    energysystem.add(solph.components.GenericStorage(
        ...
        investment = solph.Investment(ep_costs=epc_costs['storage_hydrogen']['epc'], 
                                      maximum = (scalars['leistung_trapfade_backward'][str(YEAR+5)]['storage_hydrogen'] if not is_existing_year
                                                 else abs(scalars['leistung_trapfade_backward'][str(YEAR+5)]['storage_hydrogen']-
                                                 scalars['leistung_trapfade_backward'][str(exist_year)]['storage_hydrogen'])),
                                      )
        ))
    ...
    energysystem.add(solph.components.Sink(
        ...
        inputs={b_el_out: solph.Flow(fix=demand['rechnenzentrum'], 
                                     nominal_value=1,
        )}))
    ...
    #------------------------------------------------------------------------------
    energysystem.add(solph.components.Sink(
        label='Material_demand_Biomasse', 
        inputs={b_solidf: solph.Flow(fix=demand['material_usage_biomasse'], 
                                       nominal_value=1,
        )}))
    ...
    energysystem.add(solph.components.Sink(
        label='excess_b_el', 
        inputs={b_el_out: solph.Flow(variable_costs = 200 #Abregelung Redispatch pries für EE
        )}))
    #------------------------------------------------------------------------------
    ...
    energysystem.add(solph.components.Sink(
        label='excess_b_bio', 
        inputs={b_bio: solph.Flow(variable_costs = 0
        )}))
    #------------------------------------------------------------------------------
