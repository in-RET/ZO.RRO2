...
def basic_example(PERMUATION: str) -> solph.EnergySystem:
    ...
    # NETZAUSBAU
    # ------------------------------------------------------------------------------
    AMORT_WP_NETZAUSBAU = PTH_TECHNOLOGIEN['WP_Luftwaerme']['Amortisationszeit_Netzausbau']
    ZINSSATZ_WP_NETZAUSBAU = PTH_TECHNOLOGIEN['WP_Luftwaerme']['Zinssatz'] / 100

    NETZAUSBAUKOSTEN = PTH_TECHNOLOGIEN['WP_Luftwaerme']['Kosten_Fernwaermenetzausbau'] * PTH_TECHNOLOGIEN['WP_Luftwaerme']['Laenge_Fernwaermeleitung']
    A_WP_NETZAUSBAU = economics.annuity(capex=NETZAUSBAUKOSTEN, n=AMORT_WP_NETZAUSBAU, wacc=ZINSSATZ_WP_NETZAUSBAU)
    ...
    energysystem.add(solph.components.Source(
        ...
        outputs={b_el: solph.Flow(
            nominal_value=solph.Investment(
                ep_costs=EPC_STROMTRAFO,
                maximum=MAX_LEISTUNG_STROMTRAFO
            ),
    ...
    energysystem.add(solph.components.Sink(
        label='Ueberschuss_Strom',
        inputs={b_el: solph.Flow()}
    ))

    energysystem.add(solph.components.Sink(
        label='Ueberschuss_Fernwaerme',
        inputs={b_fern: solph.Flow()}
    ))
    ...
    # ------------------------------------------------------------------------------
    CAPEX_LUFTWAERME_ERZEUGERANLAGEN = PTH_TECHNOLOGIEN['WP_Luftwaerme']['CAPEX Erzeugeranlagen']
    CAPEX_LUFTWAERME_NEBENANLAGEN = PTH_TECHNOLOGIEN['WP_Luftwaerme']['CAPEX Nebenanlagen']
    OPEX_LUFTWAERME_ERZEUGERANLAGEN = PTH_TECHNOLOGIEN['WP_Luftwaerme']['OPEX Erzeugeranlagen'] / 100
    OPEX_LUFTWAERME_NEBENANLAGEN = PTH_TECHNOLOGIEN['WP_Luftwaerme']['OPEX Nebenanlagen'] / 100
    ...
    A_LUFTWAERME_ERZEUGERANLAGEN = economics.annuity(
        capex=CAPEX_LUFTWAERME_ERZEUGERANLAGEN,
        n=AMORT_A_WP,
        wacc=ZINSSATZ_WP
    )
    B_LUFTWAERME_ERZEUGERANLAGEN = CAPEX_LUFTWAERME_ERZEUGERANLAGEN * OPEX_LUFTWAERME_ERZEUGERANLAGEN
    EPC_LUFTWAERME_ERZEUGERANLAGEN = A_LUFTWAERME_ERZEUGERANLAGEN + B_LUFTWAERME_ERZEUGERANLAGEN

    A_LUFTWAERME_NEBENANLAGEN = economics.annuity(
        capex=CAPEX_LUFTWAERME_NEBENANLAGEN,
        n=AMORT_A_WP,
        wacc=ZINSSATZ_WP
    )
    B_LUFTWAERME_NEBENANLAGEN = CAPEX_LUFTWAERME_NEBENANLAGEN * OPEX_LUFTWAERME_NEBENANLAGEN
    EPC_LUFTWAERME_NEBENANLAGEN = A_LUFTWAERME_NEBENANLAGEN + B_LUFTWAERME_NEBENANLAGEN

    EPC_LUFTWAERME = EPC_LUFTWAERME_ERZEUGERANLAGEN + EPC_LUFTWAERME_NEBENANLAGEN + A_WP_NETZAUSBAU
    ...
    if YEAR < 2040:
        energysystem.add(solph.components.Source(
            ...
            outputs={b_abwaerme_luftwaerme: solph.Flow(
                nominal_value=1,
                fix=ABWAERME_POTENTIAL_LUFTWAERME
            )}
        ))
        ...
        energysystem.add(solph.components.Converter(
            ...
            outputs={
                b_fern: solph.Flow(
                    nominal_value=solph.Investment(
                        ep_costs=EPC_LUFTWAERME,
                        maximum=MAX_LEISTUNG_LUFTWAERME
                    ),
                    custom_attributes={"emission_factor": 1 * (-1)},
                )
            },
    ...
    # ------------------------------------------------------------------------------
    CAPEX_INDUSTRIE_ERZEUGERANLAGEN = PTH_TECHNOLOGIEN['WP_Industrie']['CAPEX Erzeugeranlagen']
    CAPEX_INDUSTRIE_NEBENANLAGEN = PTH_TECHNOLOGIEN['WP_Industrie']['CAPEX Nebenanlagen']
    OPEX_INDUSTRIE_ERZEUGERANLAGEN = PTH_TECHNOLOGIEN['WP_Industrie']['OPEX Erzeugeranlagen'] / 100
    OPEX_INDUSTRIE_NEBENANLAGEN = PTH_TECHNOLOGIEN['WP_Industrie']['OPEX Nebenanlagen'] / 100
    ...
    A_INDUSTRIE_ERZEUGERANLAGEN = economics.annuity(
        capex=CAPEX_INDUSTRIE_ERZEUGERANLAGEN,
        n=AMORT_A_WP,
        wacc=ZINSSATZ_WP
    )
    B_INDUSTRIE_ERZEUGERANLAGEN = CAPEX_INDUSTRIE_ERZEUGERANLAGEN * OPEX_INDUSTRIE_ERZEUGERANLAGEN
    EPC_INDUSTRIE_ERZEUGERANLAGEN = A_INDUSTRIE_ERZEUGERANLAGEN + B_INDUSTRIE_ERZEUGERANLAGEN

    A_INDUSTRIE_NEBENANLAGEN = economics.annuity(
        capex=CAPEX_INDUSTRIE_NEBENANLAGEN,
        n=AMORT_A_WP,
        wacc=ZINSSATZ_WP
    )
    B_INDUSTRIE_NEBENANLAGEN = CAPEX_INDUSTRIE_NEBENANLAGEN * OPEX_INDUSTRIE_NEBENANLAGEN
    EPC_INDUSTRIE_NEBENANLAGEN = A_INDUSTRIE_NEBENANLAGEN + B_INDUSTRIE_NEBENANLAGEN

    EPC_INDUSTRIE = EPC_INDUSTRIE_ERZEUGERANLAGEN + EPC_INDUSTRIE_NEBENANLAGEN + A_WP_NETZAUSBAU
    ...
    if YEAR > 2025:
        energysystem.add(solph.components.Converter(
            ...
            outputs={
                b_fern: solph.Flow(
                    nominal_value=solph.Investment(
                        ep_costs=EPC_INDUSTRIE,
                        maximum=MAX_LEISTUNG_INDUSTRIE
                    ),
                    custom_attributes={"emission_factor": 1 * (-1)},
                )},
            conversion_factors={
                b_fern: COP_WP_INDUSTRIE
            }
        ))
