...
res_Electricity_in = solph.views.node(results, "ElectricityIn")
res_Electricity_out = solph.views.node(results, "ElectricityOut")
...
data = [
        res_Electricity_in["scalars"][('PV_open_north', 'ElectricityIn'), 'invest'],
        res_Electricity_in["scalars"][('PV_open_east', 'ElectricityIn'), 'invest'],
        res_Electricity_in["scalars"][('PV_open_middle', 'ElectricityIn'), 'invest'],
        res_Electricity_in["scalars"][('PV_open_swest', 'ElectricityIn'), 'invest'],
        
        res_Electricity_in["scalars"][('Wind_north', 'ElectricityIn'), 'invest'],
        res_Electricity_in["scalars"][('Wind_east', 'ElectricityIn'), 'invest'],
        res_Electricity_in["scalars"][('Wind_middle', 'ElectricityIn'), 'invest'],
        res_Electricity_in["scalars"][('Wind_swest', 'ElectricityIn'), 'invest'],
                 ]
...
data = [
        res_Electricity_in["sequences"][('PV_open_north', 'ElectricityIn'), 'flow'].sum(),
        res_Electricity_in["sequences"][('PV_open_east', 'ElectricityIn'), 'flow'].sum(),
        res_Electricity_in["sequences"][('PV_open_middle', 'ElectricityIn'), 'flow'].sum(),
        res_Electricity_in["sequences"][('PV_open_swest', 'ElectricityIn'), 'flow'].sum(),
        
        res_Electricity_in["sequences"][('Wind_north', 'ElectricityIn'), 'flow'].sum(),
        res_Electricity_in["sequences"][('Wind_east', 'ElectricityIn'), 'flow'].sum(),
        res_Electricity_in["sequences"][('Wind_middle', 'ElectricityIn'), 'flow'].sum(),
        res_Electricity_in["sequences"][('Wind_swest', 'ElectricityIn'), 'flow'].sum(),
                 ]
bars = plt.bar(text, data, color=['#2E74B5'] #"So gehts"-blau
)
xlocs, xlabs = plt.xticks()               
...
y = np.array([res_Electricity_in["scalars"][('GuD', 'ElectricityIn'), 'invest'],
               
              res_Electricity_in["scalars"][
                  ('Biomasse_elec', 'ElectricityIn'), 'invest'],
              
              res_Electricity_in["scalars"][
                  ('Biomasse_elec_heat', 'ElectricityIn'), 'invest'],
...
res_Electricity_out["sequences"][
    ('ElectricityOut', 'Electricity_demand_total'), 'flow'].sum() +
...
ee_erzeugung = (res_Electricity_in["sequences"][('PV_open_north', 'ElectricityIn'), 'flow'].sum()+
res_Electricity_in["sequences"][('PV_open_east', 'ElectricityIn'), 'flow'].sum()+
res_Electricity_in["sequences"][('PV_open_middle', 'ElectricityIn'), 'flow'].sum()+
res_Electricity_in["sequences"][('PV_open_swest', 'ElectricityIn'), 'flow'].sum()+
...
res_Electricity_in["sequences"][('Biogas- BHKW', 'ElectricityIn'), 'flow'].sum()+
...
res_Electricity_in["sequences"][('Hydro power plant', 'ElectricityIn'), 'flow'].sum()+

res_dis_heat["sequences"][('ST', 'District heating'), 'flow'].sum()+

res_dis_heat["sequences"][('Biomasse_heat', 'District heating'), 'flow'].sum()+
res_Electricity_in["sequences"][('Biomasse_elec', 'ElectricityIn'), 'flow'].sum()+

res_dis_heat["sequences"][('Biomasse_elec_heat', 'District heating'), 'flow'].sum()+
res_Electricity_in["sequences"][('Biomasse_elec_heat', 'ElectricityIn'), 'flow'].sum()+
...
(res_Electricity_in["scalars"][('PV_rooftop_north', 'ElectricityIn'), 'invest'].sum()+
res_Electricity_in["scalars"][('PV_rooftop_east', 'ElectricityIn'), 'invest'].sum()+
res_Electricity_in["scalars"][('PV_rooftop_middle', 'ElectricityIn'), 'invest'].sum()+
res_Electricity_in["scalars"][('PV_rooftop_swest', 'ElectricityIn'), 'invest'].sum())
...
fig, ax = plt.subplots(figsize=(19.1, 10.5))
res_Electricity_in['sequences'].plot(ax=ax, kind='line',
                                 drawstyle='steps-post', 
                                 color=palette, linewidth=2.5)
plt.legend(res_Electricity_in['sequences'].keys(), 
...
y = np.array([(res_oil_fuel["scalars"][('BtL', 'Oil_fuel'), 'invest']),
              ...
              (res_Electricity_in["scalars"][('Fuelcell', 'ElectricityIn'), 'invest']),
...
# Plot lines
ax.plot(
        (res_Electricity_in["sequences"]['2045-06-04 02:00:00':'2045-06-07 14:00:00'][
            ('PV_open_north', 'ElectricityIn'), 'flow']+
        res_Electricity_in["sequences"]['2045-06-04 02:00:00':'2045-06-07 14:00:00'][
            ('PV_open_east', 'ElectricityIn'), 'flow']+
        res_Electricity_in["sequences"]['2045-06-04 02:00:00':'2045-06-07 14:00:00'][
            ('PV_open_middle', 'ElectricityIn'), 'flow']+
        res_Electricity_in["sequences"]['2045-06-04 02:00:00':'2045-06-07 14:00:00'][
            ('PV_open_swest', 'ElectricityIn'), 'flow']),
        linewidth=2.5,
        label='PV'
        )
...
ax.plot(        
        (res_Electricity_in["sequences"]['2045-06-04 02:00:00':'2045-06-07 14:00:00'][
            ('Wind_north', 'ElectricityIn'), 'flow']+
        res_Electricity_in["sequences"]['2045-06-04 02:00:00':'2045-06-07 14:00:00'][
            ('Wind_east', 'ElectricityIn'), 'flow']+
        res_Electricity_in["sequences"]['2045-06-04 02:00:00':'2045-06-07 14:00:00'][
            ('Wind_middle', 'ElectricityIn'), 'flow']+
        res_Electricity_in["sequences"]['2045-06-04 02:00:00':'2045-06-07 14:00:00'][
            ('Wind_swest', 'ElectricityIn'), 'flow']),
        linewidth=2.5,
        label='Wind'
        )

ax.plot(res_Electricity_in["sequences"]['2045-06-04 02:00:00':'2045-06-07 14:00:00'][
    ('Biomasse_elec_heat', 'ElectricityIn'), 'flow'],
    linewidth=2.5,
    label='Biomasse_elec_heat')

ax.plot(res_Electricity_in["sequences"]['2045-06-04 02:00:00':'2045-06-07 14:00:00'][
    ('GuD', 'ElectricityIn'), 'flow'],
    linewidth=2.5,
        label='GuD')
...
ax.plot(res_Electricity_out["sequences"]['2045-06-04 02:00:00':'2045-06-07 14:00:00'][
    ('Battery', 'ElectricityOut'), 'flow'],
    linewidth=2.5,
        label='Battery')

ax.plot(res_Electricity_out["sequences"]['2045-06-04 02:00:00':'2045-06-07 14:00:00'][
            ('ElectricityOut', 'Electricity_demand_total'), 'flow'],
        color="red")
...
print('Electricity: ', res_Electricity_out["sequences"][('ElectricityOut', 'PtL'), 'flow'][10])
...
stromerloes = np.multiply(
    np.array(res_Electricity_out["sequences"][('ElectricityOut', 'Electrolysis'), 'flow'][:8759]),
