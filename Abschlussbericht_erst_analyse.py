...
#%%
scalars_comp_plot = False
folder_name = 'Uncertainty'
plot_variable = 'peak' #/total
component_filename = 'Installed_cap.csv'#'component_'+ plot_variable +'_flow_comparison.csv'
storage_filename = 'Storage.csv'#'peak_storage_flow_comparison.csv'
