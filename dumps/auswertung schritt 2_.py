...
for x in range(0, 11):
    ...
    energysystem.restore(dpath='2045_BS0006/', 
                         filename='BS_2045_BS0006_Im_Ex_Bilanz_Wind_P'+str(x)+'0.dump')
    ...
    res_Elec_in[f'var{x+1}'] = solph.views.node(results, "ElectricityIn")
    res_Elec_out[f'var{x+1}'] = solph.views.node(results, "ElectricityOut")
...
y = np.array([(res_Elec_in['var1']["scalars"][('PV_open_north', 'ElectricityIn'), 'invest']+
              res_Elec_in['var1']["scalars"][('PV_open_east', 'ElectricityIn'), 'invest']+
              res_Elec_in['var1']["scalars"][('PV_open_middle', 'ElectricityIn'), 'invest']+
              res_Elec_in['var1']["scalars"][('PV_open_swest', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var2']["scalars"][('PV_open_north', 'ElectricityIn'), 'invest']+
              res_Elec_in['var2']["scalars"][('PV_open_east', 'ElectricityIn'), 'invest']+
              res_Elec_in['var2']["scalars"][('PV_open_middle', 'ElectricityIn'), 'invest']+
              res_Elec_in['var2']["scalars"][('PV_open_swest', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var3']["scalars"][('PV_open_north', 'ElectricityIn'), 'invest']+
              res_Elec_in['var3']["scalars"][('PV_open_east', 'ElectricityIn'), 'invest']+
              res_Elec_in['var3']["scalars"][('PV_open_middle', 'ElectricityIn'), 'invest']+
              res_Elec_in['var3']["scalars"][('PV_open_swest', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var4']["scalars"][('PV_open_north', 'ElectricityIn'), 'invest']+
              res_Elec_in['var4']["scalars"][('PV_open_east', 'ElectricityIn'), 'invest']+
              res_Elec_in['var4']["scalars"][('PV_open_middle', 'ElectricityIn'), 'invest']+
              res_Elec_in['var4']["scalars"][('PV_open_swest', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var5']["scalars"][('PV_open_north', 'ElectricityIn'), 'invest']+
              res_Elec_in['var5']["scalars"][('PV_open_east', 'ElectricityIn'), 'invest']+
              res_Elec_in['var5']["scalars"][('PV_open_middle', 'ElectricityIn'), 'invest']+
              res_Elec_in['var5']["scalars"][('PV_open_swest', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var6']["scalars"][('PV_open_north', 'ElectricityIn'), 'invest']+
              res_Elec_in['var6']["scalars"][('PV_open_east', 'ElectricityIn'), 'invest']+
              res_Elec_in['var6']["scalars"][('PV_open_middle', 'ElectricityIn'), 'invest']+
              res_Elec_in['var6']["scalars"][('PV_open_swest', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var7']["scalars"][('PV_open_north', 'ElectricityIn'), 'invest']+
              res_Elec_in['var7']["scalars"][('PV_open_east', 'ElectricityIn'), 'invest']+
              res_Elec_in['var7']["scalars"][('PV_open_middle', 'ElectricityIn'), 'invest']+
              res_Elec_in['var7']["scalars"][('PV_open_swest', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var8']["scalars"][('PV_open_north', 'ElectricityIn'), 'invest']+
              res_Elec_in['var8']["scalars"][('PV_open_east', 'ElectricityIn'), 'invest']+
              res_Elec_in['var8']["scalars"][('PV_open_middle', 'ElectricityIn'), 'invest']+
              res_Elec_in['var8']["scalars"][('PV_open_swest', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var9']["scalars"][('PV_open_north', 'ElectricityIn'), 'invest']+
              res_Elec_in['var9']["scalars"][('PV_open_east', 'ElectricityIn'), 'invest']+
              res_Elec_in['var9']["scalars"][('PV_open_middle', 'ElectricityIn'), 'invest']+
              res_Elec_in['var9']["scalars"][('PV_open_swest', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var10']["scalars"][('PV_open_north', 'ElectricityIn'), 'invest']+
              res_Elec_in['var10']["scalars"][('PV_open_east', 'ElectricityIn'), 'invest']+
              res_Elec_in['var10']["scalars"][('PV_open_middle', 'ElectricityIn'), 'invest']+
              res_Elec_in['var10']["scalars"][('PV_open_swest', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var11']["scalars"][('PV_open_north', 'ElectricityIn'), 'invest']+
              res_Elec_in['var11']["scalars"][('PV_open_east', 'ElectricityIn'), 'invest']+
              res_Elec_in['var11']["scalars"][('PV_open_middle', 'ElectricityIn'), 'invest']+
              res_Elec_in['var11']["scalars"][('PV_open_swest', 'ElectricityIn'), 'invest'])
              ])
...
with pd.ExcelWriter('Auswertung Import Export Bilanz.xlsx', engine='openpyxl') as writer:
...
y = np.array([(res_Elec_in['var1']["scalars"][('PV_rooftop_north', 'ElectricityIn'), 'invest']+
              res_Elec_in['var1']["scalars"][('PV_rooftop_east', 'ElectricityIn'), 'invest']+
              res_Elec_in['var1']["scalars"][('PV_rooftop_middle', 'ElectricityIn'), 'invest']+
              res_Elec_in['var1']["scalars"][('PV_rooftop_swest', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var2']["scalars"][('PV_rooftop_north', 'ElectricityIn'), 'invest']+
              res_Elec_in['var2']["scalars"][('PV_rooftop_east', 'ElectricityIn'), 'invest']+
              res_Elec_in['var2']["scalars"][('PV_rooftop_middle', 'ElectricityIn'), 'invest']+
              res_Elec_in['var2']["scalars"][('PV_rooftop_swest', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var3']["scalars"][('PV_rooftop_north', 'ElectricityIn'), 'invest']+
              res_Elec_in['var3']["scalars"][('PV_rooftop_east', 'ElectricityIn'), 'invest']+
              res_Elec_in['var3']["scalars"][('PV_rooftop_middle', 'ElectricityIn'), 'invest']+
              res_Elec_in['var3']["scalars"][('PV_rooftop_swest', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var4']["scalars"][('PV_rooftop_north', 'ElectricityIn'), 'invest']+
              res_Elec_in['var4']["scalars"][('PV_rooftop_east', 'ElectricityIn'), 'invest']+
              res_Elec_in['var4']["scalars"][('PV_rooftop_middle', 'ElectricityIn'), 'invest']+
              res_Elec_in['var4']["scalars"][('PV_rooftop_swest', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var5']["scalars"][('PV_rooftop_north', 'ElectricityIn'), 'invest']+
              res_Elec_in['var5']["scalars"][('PV_rooftop_east', 'ElectricityIn'), 'invest']+
              res_Elec_in['var5']["scalars"][('PV_rooftop_middle', 'ElectricityIn'), 'invest']+
              res_Elec_in['var5']["scalars"][('PV_rooftop_swest', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var6']["scalars"][('PV_rooftop_north', 'ElectricityIn'), 'invest']+
              res_Elec_in['var6']["scalars"][('PV_rooftop_east', 'ElectricityIn'), 'invest']+
              res_Elec_in['var6']["scalars"][('PV_rooftop_middle', 'ElectricityIn'), 'invest']+
              res_Elec_in['var6']["scalars"][('PV_rooftop_swest', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var7']["scalars"][('PV_rooftop_north', 'ElectricityIn'), 'invest']+
              res_Elec_in['var7']["scalars"][('PV_rooftop_east', 'ElectricityIn'), 'invest']+
              res_Elec_in['var7']["scalars"][('PV_rooftop_middle', 'ElectricityIn'), 'invest']+
              res_Elec_in['var7']["scalars"][('PV_rooftop_swest', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var8']["scalars"][('PV_rooftop_north', 'ElectricityIn'), 'invest']+
              res_Elec_in['var8']["scalars"][('PV_rooftop_east', 'ElectricityIn'), 'invest']+
              res_Elec_in['var8']["scalars"][('PV_rooftop_middle', 'ElectricityIn'), 'invest']+
              res_Elec_in['var8']["scalars"][('PV_rooftop_swest', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var9']["scalars"][('PV_rooftop_north', 'ElectricityIn'), 'invest']+
              res_Elec_in['var9']["scalars"][('PV_rooftop_east', 'ElectricityIn'), 'invest']+
              res_Elec_in['var9']["scalars"][('PV_rooftop_middle', 'ElectricityIn'), 'invest']+
              res_Elec_in['var9']["scalars"][('PV_rooftop_swest', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var10']["scalars"][('PV_rooftop_north', 'ElectricityIn'), 'invest']+
              res_Elec_in['var10']["scalars"][('PV_rooftop_east', 'ElectricityIn'), 'invest']+
              res_Elec_in['var10']["scalars"][('PV_rooftop_middle', 'ElectricityIn'), 'invest']+
              res_Elec_in['var10']["scalars"][('PV_rooftop_swest', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var11']["scalars"][('PV_rooftop_north', 'ElectricityIn'), 'invest']+
              res_Elec_in['var11']["scalars"][('PV_rooftop_east', 'ElectricityIn'), 'invest']+
              res_Elec_in['var11']["scalars"][('PV_rooftop_middle', 'ElectricityIn'), 'invest']+
              res_Elec_in['var11']["scalars"][('PV_rooftop_swest', 'ElectricityIn'), 'invest'])
              ])
...
with pd.ExcelWriter('Auswertung Import Export Bilanz.xlsx', engine='openpyxl', mode='a') as writer:
...
y = np.array([(res_Elec_in['var1']["scalars"][('Wind_north', 'ElectricityIn'), 'invest']#+
               # res_Elec_in['var1']["scalars"][('Wind_east', 'ElectricityIn'), 'invest']+
               # res_Elec_in['var1']["scalars"][('Wind_middle', 'ElectricityIn'), 'invest']+
               # res_Elec_in['var1']["scalars"][('Wind_swest', 'ElectricityIn'), 'invest']
               ),
              
              (res_Elec_in['var2']["scalars"][('Wind_north', 'ElectricityIn'), 'invest']#+
               # res_Elec_in['var2']["scalars"][('Wind_east', 'ElectricityIn'), 'invest']+
               # res_Elec_in['var2']["scalars"][('Wind_middle', 'ElectricityIn'), 'invest']+
               # res_Elec_in['var2']["scalars"][('Wind_swest', 'ElectricityIn'), 'invest']
               ),
              
              (res_Elec_in['var3']["scalars"][('Wind_north', 'ElectricityIn'), 'invest']#+
               # res_Elec_in['var3']["scalars"][('Wind_east', 'ElectricityIn'), 'invest']+
               # res_Elec_in['var3']["scalars"][('Wind_middle', 'ElectricityIn'), 'invest']+
               # res_Elec_in['var3']["scalars"][('Wind_swest', 'ElectricityIn'), 'invest']
               ),
              
              (res_Elec_in['var4']["scalars"][('Wind_north', 'ElectricityIn'), 'invest']#+
               # res_Elec_in['var4']["scalars"][('Wind_east', 'ElectricityIn'), 'invest']+
               # res_Elec_in['var4']["scalars"][('Wind_middle', 'ElectricityIn'), 'invest']+
               # res_Elec_in['var4']["scalars"][('Wind_swest', 'ElectricityIn'), 'invest']
               ),
              
              (res_Elec_in['var5']["scalars"][('Wind_north', 'ElectricityIn'), 'invest']#+
               # res_Elec_in['var5']["scalars"][('Wind_east', 'ElectricityIn'), 'invest']+
               # res_Elec_in['var5']["scalars"][('Wind_middle', 'ElectricityIn'), 'invest']+
               # res_Elec_in['var5']["scalars"][('Wind_swest', 'ElectricityIn'), 'invest']
               ),
              
              (res_Elec_in['var6']["scalars"][('Wind_north', 'ElectricityIn'), 'invest']#+
               # res_Elec_in['var6']["scalars"][('Wind_east', 'ElectricityIn'), 'invest']+
               # res_Elec_in['var6']["scalars"][('Wind_middle', 'ElectricityIn'), 'invest']+
               # res_Elec_in['var6']["scalars"][('Wind_swest', 'ElectricityIn'), 'invest']
               ),
              
              (res_Elec_in['var7']["scalars"][('Wind_north', 'ElectricityIn'), 'invest']#+
               # res_Elec_in['var7']["scalars"][('Wind_east', 'ElectricityIn'), 'invest']+
               # res_Elec_in['var7']["scalars"][('Wind_middle', 'ElectricityIn'), 'invest']+
               # res_Elec_in['var7']["scalars"][('Wind_swest', 'ElectricityIn'), 'invest']
               ),
              
              (res_Elec_in['var8']["scalars"][('Wind_north', 'ElectricityIn'), 'invest']#+
               # res_Elec_in['var8']["scalars"][('Wind_east', 'ElectricityIn'), 'invest']+
               # res_Elec_in['var8']["scalars"][('Wind_middle', 'ElectricityIn'), 'invest']+
               # res_Elec_in['var8']["scalars"][('Wind_swest', 'ElectricityIn'), 'invest']
               ),
              
              (res_Elec_in['var9']["scalars"][('Wind_north', 'ElectricityIn'), 'invest']#+
               # res_Elec_in['var9']["scalars"][('Wind_east', 'ElectricityIn'), 'invest']+
               # res_Elec_in['var9']["scalars"][('Wind_middle', 'ElectricityIn'), 'invest']+
               # res_Elec_in['var9']["scalars"][('Wind_swest', 'ElectricityIn'), 'invest']
               ),
              
              (res_Elec_in['var10']["scalars"][('Wind_north', 'ElectricityIn'), 'invest']#+
               # res_Elec_in['var10']["scalars"][('Wind_east', 'ElectricityIn'), 'invest']+
               # res_Elec_in['var10']["scalars"][('Wind_middle', 'ElectricityIn'), 'invest']+
               # res_Elec_in['var10']["scalars"][('Wind_swest', 'ElectricityIn'), 'invest']
               ),
              
              (res_Elec_in['var11']["scalars"][('Wind_north', 'ElectricityIn'), 'invest']+
                res_Elec_in['var11']["scalars"][('Wind_east', 'ElectricityIn'), 'invest']+
                res_Elec_in['var11']["scalars"][('Wind_middle', 'ElectricityIn'), 'invest']+
                res_Elec_in['var11']["scalars"][('Wind_swest', 'ElectricityIn'), 'invest']
               )
              ])
...
energiemenge_1=(
    (res_Elec_in['var1']["sequences"][('Wind_north', 'ElectricityIn'), 'flow'].sum()
    ...
    (res_Elec_in['var1']["sequences"][('PV_open_north', 'ElectricityIn'), 'flow'].sum()+
    res_Elec_in['var1']["sequences"][('PV_open_east', 'ElectricityIn'), 'flow'].sum()+
    res_Elec_in['var1']["sequences"][('PV_open_middle', 'ElectricityIn'), 'flow'].sum()+
    res_Elec_in['var1']["sequences"][('PV_open_swest', 'ElectricityIn'), 'flow'].sum()))


energiemenge_11=(
    (res_Elec_in['var11']["sequences"][('Wind_north', 'ElectricityIn'), 'flow'].sum()
    ...
    (res_Elec_in['var11']["sequences"][('PV_open_north', 'ElectricityIn'), 'flow'].sum()+
    res_Elec_in['var11']["sequences"][('PV_open_east', 'ElectricityIn'), 'flow'].sum()+
    res_Elec_in['var11']["sequences"][('PV_open_middle', 'ElectricityIn'), 'flow'].sum()+
    res_Elec_in['var11']["sequences"][('PV_open_swest', 'ElectricityIn'), 'flow'].sum()))
...
y = np.array([res_Elec_out['var1']["sequences"][
    ('ElectricityOut', 'Export_Electricity'), 'flow'].sum(),
    
    res_Elec_out['var2']["sequences"][
        ('ElectricityOut', 'Export_Electricity'), 'flow'].sum(),
    
    res_Elec_out['var3']["sequences"][
        ('ElectricityOut', 'Export_Electricity'), 'flow'].sum(),
    
    res_Elec_out['var4']["sequences"][
        ('ElectricityOut', 'Export_Electricity'), 'flow'].sum(),
    
    res_Elec_out['var5']["sequences"][
        ('ElectricityOut', 'Export_Electricity'), 'flow'].sum(),
    
    res_Elec_out['var6']["sequences"][
        ('ElectricityOut', 'Export_Electricity'), 'flow'].sum(),
    
    res_Elec_out['var7']["sequences"][
        ('ElectricityOut', 'Export_Electricity'), 'flow'].sum(),
    
    res_Elec_out['var8']["sequences"][
        ('ElectricityOut', 'Export_Electricity'), 'flow'].sum(),
    
    res_Elec_out['var9']["sequences"][
        ('ElectricityOut', 'Export_Electricity'), 'flow'].sum(),
    
    res_Elec_out['var10']["sequences"][
        ('ElectricityOut', 'Export_Electricity'), 'flow'].sum(),
    
    res_Elec_out['var11']["sequences"][
        ('ElectricityOut', 'Export_Electricity'), 'flow'].sum(),
...
y = np.array([(res_Elec_in['var1']["scalars"][('Biomasse_elec_heat', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var2']["scalars"][('Biomasse_elec_heat', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var3']["scalars"][('Biomasse_elec_heat', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var4']["scalars"][('Biomasse_elec_heat', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var5']["scalars"][('Biomasse_elec_heat', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var6']["scalars"][('Biomasse_elec_heat', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var7']["scalars"][('Biomasse_elec_heat', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var8']["scalars"][('Biomasse_elec_heat', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var9']["scalars"][('Biomasse_elec_heat', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var10']["scalars"][('Biomasse_elec_heat', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var11']["scalars"][('Biomasse_elec_heat', 'ElectricityIn'), 'invest'])
              ])
...
y = np.array([(res_Elec_in['var1']["scalars"][('GuD', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var2']["scalars"][('GuD', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var3']["scalars"][('GuD', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var4']["scalars"][('GuD', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var5']["scalars"][('GuD', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var6']["scalars"][('GuD', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var7']["scalars"][('GuD', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var8']["scalars"][('GuD', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var9']["scalars"][('GuD', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var10']["scalars"][('GuD', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var11']["scalars"][('GuD', 'ElectricityIn'), 'invest'])
              ])
...
y = np.array([(res_Elec_in['var1']["scalars"][('Biomasse_elec', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var2']["scalars"][('Biomasse_elec', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var3']["scalars"][('Biomasse_elec', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var4']["scalars"][('Biomasse_elec', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var5']["scalars"][('Biomasse_elec', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var6']["scalars"][('Biomasse_elec', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var7']["scalars"][('Biomasse_elec', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var8']["scalars"][('Biomasse_elec', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var9']["scalars"][('Biomasse_elec', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var10']["scalars"][('Biomasse_elec', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var11']["scalars"][('Biomasse_elec', 'ElectricityIn'), 'invest'])
              ])
...
fig, ax = plt.subplots(figsize=(19.1, 10.5))
res_Elec_in['var11']['sequences'].plot(ax=ax, kind='line',
                                 drawstyle='steps-post', 
                                 color=palette, linewidth=2.5)
plt.legend(res_Elec_in['var11']['sequences'].keys(), 
...
fig = plt.figure(figsize=(19.1, 10.5))
plt.plot(date_time_index,
         res_Heat_storage_dist_heat['var1']['sequences'][
             ('Heat storage_dist_heat','None'),'storage_content'][:8760], 
         label='District Heat Storage')

plt.plot(date_time_index,
          res_Heat_storage_seasonal['var1']['sequences'][
              ('Heat storage_seasonal','None'),'storage_content'][:8760], 
          label='Seasonal Heat Storage')
# plt.ylim(-3,103)
plt.grid()
...
y = np.array([(res_Elec_in['var1']["scalars"][('Fuelcell', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var2']["scalars"][('Fuelcell', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var3']["scalars"][('Fuelcell', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var4']["scalars"][('Fuelcell', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var5']["scalars"][('Fuelcell', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var6']["scalars"][('Fuelcell', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var7']["scalars"][('Fuelcell', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var8']["scalars"][('Fuelcell', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var9']["scalars"][('Fuelcell', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var10']["scalars"][('Fuelcell', 'ElectricityIn'), 'invest']),
              
              (res_Elec_in['var11']["scalars"][('Fuelcell', 'ElectricityIn'), 'invest'])
              ])
...
fig, ax = plt.subplots(figsize=(19.1, 10.5))
res_Elec_in['var1']['sequences'].plot(ax=ax, kind='line',
                                 drawstyle='steps-post', 
                                 color=palette, linewidth=2.5)
plt.legend(res_Elec_in['var1']['sequences'].keys(), 
...
x = np.array(["kein Wind I", "kein Wind E", 
              "10 I", "10 E", "20 I", "20 E", "30 I", "30 E",
              "40 I", "40 E", "50 I", "50 E", "60 I", "60 E", 
              "70 I", "70 E", "80 I", "80 E", "90 I", "90 E",
              "viel Wind I", "viel Wind E"])

y = np.array([
    (
    res_Elec_hoes['var1']["sequences"][('Import_Electricity', 'Electricity_Hös'), 'flow'].sum()+
    res_h2['var1']["sequences"][('Import_Hydrogen', 'Hydrogen'), 'flow'].sum()+
    ...
    res_Elec_out['var1']["sequences"][
        ('ElectricityOut', 'Export_Electricity'), 'flow'].sum(),
    
    (res_Elec_hoes['var2']["sequences"][('Import_Electricity', 'Electricity_Hös'), 'flow'].sum()+
    res_h2['var2']["sequences"][('Import_Hydrogen', 'Hydrogen'), 'flow'].sum()+
    res_oil_fuel['var2']["sequences"][
        ('Import_Synthetic_fuel', 'Oil_fuel'), 'flow'].sum()+
    res_oil_fuel['var2']["sequences"][
        ('Import_Oil', 'Oil_fuel'), 'flow'].sum()+
    ...
    (res_Elec_hoes['var3']["sequences"][('Import_Electricity', 'Electricity_Hös'), 'flow'].sum()+
    res_h2['var3']["sequences"][('Import_Hydrogen', 'Hydrogen'), 'flow'].sum()+
    res_oil_fuel['var3']["sequences"][
        ('Import_Synthetic_fuel', 'Oil_fuel'), 'flow'].sum()+
    res_oil_fuel['var3']["sequences"][
        ('Import_Oil', 'Oil_fuel'), 'flow'].sum()+
    ...
    (res_Elec_hoes['var4']["sequences"][('Import_Electricity', 'Electricity_Hös'), 'flow'].sum()+
    res_h2['var4']["sequences"][('Import_Hydrogen', 'Hydrogen'), 'flow'].sum()+
    res_oil_fuel['var4']["sequences"][
        ('Import_Synthetic_fuel', 'Oil_fuel'), 'flow'].sum()+
    res_oil_fuel['var4']["sequences"][
        ('Import_Oil', 'Oil_fuel'), 'flow'].sum()+
    ...
    (res_Elec_hoes['var5']["sequences"][('Import_Electricity', 'Electricity_Hös'), 'flow'].sum()+
    res_h2['var5']["sequences"][('Import_Hydrogen', 'Hydrogen'), 'flow'].sum()+
    res_oil_fuel['var5']["sequences"][
        ('Import_Synthetic_fuel', 'Oil_fuel'), 'flow'].sum()+
    res_oil_fuel['var5']["sequences"][
        ('Import_Oil', 'Oil_fuel'), 'flow'].sum()+
    ...
    (res_Elec_hoes['var6']["sequences"][('Import_Electricity', 'Electricity_Hös'), 'flow'].sum()+
    res_h2['var6']["sequences"][('Import_Hydrogen', 'Hydrogen'), 'flow'].sum()+
    res_oil_fuel['var6']["sequences"][
        ('Import_Synthetic_fuel', 'Oil_fuel'), 'flow'].sum()+
    res_oil_fuel['var6']["sequences"][
        ('Import_Oil', 'Oil_fuel'), 'flow'].sum()+
    ...
    (res_Elec_hoes['var7']["sequences"][('Import_Electricity', 'Electricity_Hös'), 'flow'].sum()+
    res_h2['var7']["sequences"][('Import_Hydrogen', 'Hydrogen'), 'flow'].sum()+
    res_oil_fuel['var7']["sequences"][
        ('Import_Synthetic_fuel', 'Oil_fuel'), 'flow'].sum()+
    res_oil_fuel['var7']["sequences"][
        ('Import_Oil', 'Oil_fuel'), 'flow'].sum()+
    ...
    (res_Elec_hoes['var8']["sequences"][('Import_Electricity', 'Electricity_Hös'), 'flow'].sum()+
    res_h2['var8']["sequences"][('Import_Hydrogen', 'Hydrogen'), 'flow'].sum()+
    res_oil_fuel['var8']["sequences"][
        ('Import_Synthetic_fuel', 'Oil_fuel'), 'flow'].sum()+
    res_oil_fuel['var8']["sequences"][
        ('Import_Oil', 'Oil_fuel'), 'flow'].sum()+
    ...
    (res_Elec_hoes['var9']["sequences"][('Import_Electricity', 'Electricity_Hös'), 'flow'].sum()+
    res_h2['var9']["sequences"][('Import_Hydrogen', 'Hydrogen'), 'flow'].sum()+
    res_oil_fuel['var9']["sequences"][
        ('Import_Synthetic_fuel', 'Oil_fuel'), 'flow'].sum()+
    res_oil_fuel['var9']["sequences"][
        ('Import_Oil', 'Oil_fuel'), 'flow'].sum()+
    ...
    (res_Elec_hoes['var10']["sequences"][('Import_Electricity', 'Electricity_Hös'), 'flow'].sum()+
    res_h2['var10']["sequences"][('Import_Hydrogen', 'Hydrogen'), 'flow'].sum()+
    res_oil_fuel['var10']["sequences"][
        ('Import_Synthetic_fuel', 'Oil_fuel'), 'flow'].sum()+
    res_oil_fuel['var10']["sequences"][
        ('Import_Oil', 'Oil_fuel'), 'flow'].sum()+
    ...
    (res_Elec_hoes['var11']["sequences"][('Import_Electricity', 'Electricity_Hös'), 'flow'].sum()+
    res_h2['var11']["sequences"][('Import_Hydrogen', 'Hydrogen'), 'flow'].sum()+
    res_oil_fuel['var11']["sequences"][
        ('Import_Synthetic_fuel', 'Oil_fuel'), 'flow'].sum()+
    res_oil_fuel['var11']["sequences"][
        ('Import_Oil', 'Oil_fuel'), 'flow'].sum()+
...
with pd.ExcelWriter('Auswertung Import Export Bilanz.xlsx', engine='openpyxl', mode='a') as writer:
    pd.DataFrame(combined).to_excel(writer, sheet_name='Import Export Bilanz', index=False)